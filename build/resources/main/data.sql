...
VALUES
    (1, 'batman', 'Bruce Wayne','batman','batman'),
    (2, 'superman', 'Clark Kent','superman','superman'),
    (3, 'catwoman', 'Selina Kyle','catwoman','catwoman'),
    (4, 'daredevil', 'Matt Murdock','daredevil','daredevil'),
    (5, 'alfred', 'Alfred Pennyworth','alfred','alfred'),
    (6, 'dococ', 'Otto Octavius','dococ','dococ'),
    (7, 'zod', 'Dru-Zod','zod','zod'),
    (8, 'spiderman', 'Peter Parker','spiderman','spiderman'),
    (9, 'ironman', 'Tony Stark','ironman','ironman'),
    (10, 'profx', 'Charles Xavier','profx','profx');
